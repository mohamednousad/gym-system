  ...
  <div class="main-content" id="mainContent">
    <header class="topbar">
      ...
      <div class="topbar-actions">
        <a href="/gym-pro/views/user/notifications.php" class="topbar-notif" title="Notifications">&#128276;<?php if($_badge>0):?><span class="notif-dot"></span><?php endif;?></a>
        ...
        <a href="/gym-pro/logout.php" class="btn btn-sm btn-secondary">Logout</a>
      </div>
    </header>
    <div class="page-body">
      <?= render_flash() ?>