...
<div class="modal-overlay" id="confirmDeleteOverlay">
  <div class="modal confirm-modal">
    <div class="modal-body" style="text-align:center;padding:32px 24px;">
      ...
      <p class="confirm-text" id="confirmDeleteMsg">Are you sure you want to delete this record? This action cannot be undone.</p>
    </div>
...
<div class="modal-overlay" id="imageViewerOverlay">
  <div class="modal" style="max-width:600px;background:transparent;border:none;box-shadow:none;">
    <div style="text-align:right;margin-bottom:8px;">
      <button data-close-modal="imageViewerOverlay" style="background:rgba(0,0,0,0.6);border:none;color:#fff;width:34px;height:34px;border-radius:50%;cursor:pointer;font-size:16px;">&#x2715;</button>
    </div>
